...
const Pricing = ({
  ...
  return (
    <section
      id="pricing"
      className={cn(
        `mx-auto flex w-full max-w-7xl flex-col gap-12 px-8 py-20 transition-all duration-700 ease-in-out lg:py-48 ${isVisible ? "opacity-100" : "translate-y-10 opacity-0"}`,
        className,
      )}
      ref={ref}
    >
      <div className="flex flex-col items-center gap-4">
        <h2 className="w-full text-center text-3xl font-extrabold">Pricing</h2>
        <HomeCTAExtraInfo />
      </div>
