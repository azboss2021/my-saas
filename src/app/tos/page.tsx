...
// EDIT THESE
const websiteURL = "MySaaS.com";
const companyName = "MySaaS";
...
const TOSPage = () => {
  return (
    <section className="max-w-prose p-8 flex flex-col gap-6 items-start pb-32 mx-auto">
      ...
      <p>
        By accessing this Website, accessible from {websiteURL}, you are
      ...
      <p>
        ...
        on {companyName}'s Website for personal, non-commercial transitory
      ...
      <ul>
        ...
        <li>
          attempt to reverse engineer any software contained on {companyName}'s
          Website;
        </li>
        <li>
      ...
      <p>
        This will let {companyName} to terminate upon violations of any of these
      ...
      <p>
        All the materials on {companyName}'s Website are provided "as is".{" "}
        {companyName} makes no warranties, may it be expressed or implied,
        therefore negates all other warranties. Furthermore, {companyName} does
      ...
      <p>
        ...
        on
        {companyName}'s Website, even if {companyName} or an authorize
      ...
      <p>
        The materials appearing on {companyName}'s Website may include
        technical, typographical, or photographic errors. {companyName} will not
        promise that any of the materials in this Website are accurate,
        complete, or current.
        {companyName} may change the materials contained on its Website at any
        time without notice. {companyName} does not make any commitment to
      ...
      <p>
        ...
        presence of any link does not imply endorsement by {companyName} of the
      ...
      <p>
        {companyName} may revise these Terms of Use for its Website at any time
      ...
      <p>
        Any claim related to {companyName}'s Website shall be governed by the
